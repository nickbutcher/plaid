    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (mode) {
            ...
            case MODE_FOLLOWERS:
                ...
                title.setText(getResources().getQuantityString(
                        io.plaidapp.R.plurals.follower_count,
    ...
    private class PlayerAdapter<T extends PlayerListable>
            ...
            switch (viewType) {
                ...
                default: // TYPE_LOADING
                    return new LoadingViewHolder(
                            layoutInflater.inflate(io.plaidapp.R.layout.list_loading,
                                    parent,
                                    false));
            }
        }
        ...
        private PlayerViewHolder createPlayerViewHolder(ViewGroup parent) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                player.putExtra(Activities.Player.EXTRA_PLAYER, user);
