...
dependencies {
    constraints {
        ...
        api("${Libs.TEST_AX_ESPRESSO_CONTRIB}:$espresso")
        api("${Libs.TEST_AX_ESPRESSO_CORE}:$espresso")
        api("${Libs.TEST_JUNIT}:$junit")
        api("${Libs.TEST_AX_JUNIT_EXT}:$extJunit")
        ...
        api("${Libs.TEST_AX_RULES}:$test_rules")
        api("${Libs.TEST_AX_RUNNER}:$test_runner")
        api("${Libs.TEST_AX_UIAUTOMATOR}:$ui_automator")
    }
}
