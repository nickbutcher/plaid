...
public class DribbbleShot extends Activity {
    ...
    public void postComment(View view) {
        if (dribbblePrefs.isLoggedIn()) {
            ...
            FabTransform.addExtras(login, ContextCompat.getColor(
                    DribbbleShot.this, io.plaidapp.R.color.background_light),
                    io.plaidapp.R.drawable.ic_comment_add);
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(
                    DribbbleShot.this, postComment, getString(io.plaidapp.R.string.transition_dribbble_login));
    ...
    void openLink(String url) {
        CustomTabActivityHelper.openCustomTab(
                ...
                new CustomTabsIntent.Builder()
                    .setToolbarColor(ContextCompat.getColor(DribbbleShot.this, io.plaidapp.R.color.dribbble))
            ...
            Palette.from(bitmap)
                    ...
                    .generate(palette -> {
                        ...
                        shotSpacer.setBackground(
                                ...
                                ContextCompat.getColor(DribbbleShot.this, io.plaidapp.R.color.mid_grey),
                                true));
    ...
    private View.OnClickListener fabClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (dribbblePrefs.isLoggedIn()) {
                ...
                FabTransform.addExtras(login, ContextCompat.getColor(DribbbleShot.this,
                        io.plaidapp.R.color.dribbble), io.plaidapp.R.drawable.ic_heart_empty_56dp);
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation
                        (DribbbleShot.this, fab, getString(io.plaidapp.R.string.transition_dribbble_login));
    ...
    private void setupCommenting() {
        ...
        if (allowComment && commentFooter == null) {
            ...
            Toast.makeText(getApplicationContext(),
                    io.plaidapp.R.string.prospects_cant_post, Toast.LENGTH_SHORT).show();
        }
    ...
    class CommentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if (position == 1) {
                if (loading)  return io.plaidapp.R.layout.loading;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            switch (viewType) {
                ...
                case io.plaidapp.R.layout.loading:
