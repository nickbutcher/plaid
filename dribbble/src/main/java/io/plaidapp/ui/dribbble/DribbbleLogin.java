    ...
    void showLoggedInUser() {
        ...
        authenticatedUser.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                final View v = LayoutInflater.from(DribbbleLogin.this).inflate(
                        io.plaidapp.R.layout.toast_logged_in_confirmation, null, false);
                ((TextView) v.findViewById(io.plaidapp.R.id.name)).setText(user.name.toLowerCase());
