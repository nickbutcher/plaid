...
import io.plaidapp.base.data.LoadSourceCallback
 ...
 */
class DesignerNewsRepository(private val service: io.plaidapp.base.designernews.data.api.DesignerNewsService) {
